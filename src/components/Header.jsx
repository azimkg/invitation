        ...
        <div className="backImg w-full h-full relative z-20">
            ...
            <div className="relative z-20 flex items-start sm:items-center lg:items-start container flex-col lg:flex-row justify-center gap-10 py-12 md:py-28 w-full h-full">
                <div className="relative firstBlock">
                    <img className="object-cover rounded-2xl w-full h-full levitatePhoto" src={photo13} alt="Image" />
                    <img className="absolute blockImg2 top-16 -left-14 firstTwo object-cover rounded-2xl" src={photo10} alt="image" />
                    <img className="absolute blockImg3 -bottom-14 right-10 firstTwo object-cover rounded-2xl levitatePhoto" src={photo14} alt="image" />
                ...
                <div className="flex flex-col items-center justify-center mt-16 w-full sm:w-auto">
                    ...
                    <h1 className="text-3xl md:text-5xl font-pacif text-[#6D7561] mt-10 text-center">Чынгыз и Мээрим</h1>
                ...
                <div className="relative secondBlock">
                    <img className="w-full h-full object-cover rounded-2xl" src={photo3} alt="Image" />
                    <img className="absolute top-28 blockImg1 -right-20 w-40 sm:w-52 h-40 sm:h-52 object-cover rounded-2xl" src={photo2} alt="image" />
