    ...
    return (
        <div ref={section3Ref} className="relative">
            ...
            <div className="my-16 py-12 relative z-20 bg-mask bg-[#6D726C]">
                ...
                <h2 className="text-4xl tracking-[3px] text-white container font-pacif leading-loose text-center mb-6">
                ...
                <h2 className="text-[#B5B8B4] font-pacif font-medium text-xl sm:text-2xl text-center owner-text">
                    Той ээлери:
                </h2>
